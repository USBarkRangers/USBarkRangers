...
Backend/emulator fixtures begin with the first relevant phase; there are no empty fixture directories in phase 1. Phase 3 will use synthetic emulator accounts and provider adapters that prevent real billing/support side effects. Follow the Firebase ownership guide before any future infrastructure change.
