...
| Budget alerts/manual monitoring still needed | P1 before expansion | Controlled release can proceed if Carter actively monitors dashboards. | Configure alerts before sustained or promoted broader beta. |
